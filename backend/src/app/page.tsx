...
export default function Home() {
  return (
    <main className="min-h-screen bg-[linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_46%,_#fff9f2_100%)] text-slate-900">
      <section className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-6 sm:px-10 lg:px-8 lg:py-8">
        <nav className="sticky top-4 z-20 flex items-center justify-between rounded-full border border-slate-200/80 bg-white/80 px-5 py-3 shadow-sm backdrop-blur">
        ...
        <section
          id="about"
          className="grid gap-8 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_20px_80px_-32px_rgba(15,23,42,0.35)] sm:p-8 lg:grid-cols-[1.05fr_0.95fr] lg:p-10"
        >
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#services"
                className="rounded-full border border-slate-300 bg-white px-6 py-3 text-center font-medium text-slate-700 transition hover:border-slate-400 hover:bg-slate-50"
              >
        ...
        <section className="rounded-[1.5rem] border border-slate-200 bg-white/80 px-4 py-4 shadow-sm backdrop-blur sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm font-semibold uppercase tracking-[0.25em] text-slate-400 sm:gap-8">
        ...
        <section id="services" className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {services.map((service) => (
              <article
                key={service.title}
                className="group rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
        ...
        <section id="work" className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Featured work</p>
              <h2 className="mt-2 text-3xl font-semibold text-slate-950 sm:text-4xl">Templates designed to impress clients.</h2>
            </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            {projects.map((project) => (
              <article key={project.title} className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:shadow-md">
                <div className="h-36 rounded-[1.1rem] border border-dashed border-slate-300 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.12),_transparent_45%),linear-gradient(135deg,_#ffffff_0%,_#eef4ff_100%)]" />
                <p className="mt-4 text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">{project.category}</p>
        ...
        <section id="contact" className="rounded-[1.75rem] border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <a
              ...
              className="rounded-full bg-slate-950 px-6 py-3 text-center font-medium text-white transition hover:bg-slate-700"
            >
